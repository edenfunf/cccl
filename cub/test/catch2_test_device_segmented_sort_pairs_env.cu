...
TEST_CASE("DeviceSegmentedSort::SortPairs works with default environment", "[segmented_sort][pairs][device]")
{
...
TEST_CASE("DeviceSegmentedSort::SortPairsDescending works with default environment", "[segmented_sort][pairs][device]")
{
  auto keys_in    = c2h::device_vector<int>{8, 6, 7, 5, 3, 0, 9};
  auto keys_out   = c2h::device_vector<int>(7);
  auto values_in  = c2h::device_vector<int>{0, 1, 2, 3, 4, 5, 6};

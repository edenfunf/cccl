...
CCCL_DEPRECATED_BECAUSE("Use cuda::make_constant_iterator instead") inline
  _CCCL_HOST_DEVICE constant_iterator<ValueT, IndexT>
  make_constant_iterator(ValueT x, IndexT i = int())
{

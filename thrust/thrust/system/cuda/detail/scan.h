  ...
  ScanOp scan_op)
{
  using diff_t           = thrust::detail::it_difference_t<InputIt>;
  diff_t const num_items = ::cuda::std::distance(first, last);
  return thrust::cuda_cub::inclusive_scan_n(policy, first, num_items, result, ::cuda::std::move(init), scan_op);
}
  ...
  ScanOp scan_op)
{
  using diff_t           = thrust::detail::it_difference_t<InputIt>;
  diff_t const num_items = ::cuda::std::distance(first, last);
  return thrust::cuda_cub::exclusive_scan_n(policy, first, num_items, result, ::cuda::std::move(init), scan_op);
}
